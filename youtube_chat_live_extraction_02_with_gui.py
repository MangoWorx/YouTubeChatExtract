...
# Accept YouTube URL and driver path as command-line arguments
if len(sys.argv) != 3:
    print("Usage: python youtube_chat_live_extraction_02.py <youtube_url> <driver_path>")
    sys.exit(1)
...
with open(r'C:\Users\richa\Desktop\YouTube Chat\youtube_TheStockMarket_chat.txt', "a", encoding="utf-8") as f:
    while True:
        try:
